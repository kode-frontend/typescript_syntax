...
/**
 * Дженерик для вывода типа на основе переданного аргумента
 */

type Identity<T> = (arg: T) => T

const identityNumber: Identity<number | string | boolean> = (arg) => {
    return arg
}
...
// const identity: Identity<number | string | boolean> = (arg) => {
//     return arg
// }
